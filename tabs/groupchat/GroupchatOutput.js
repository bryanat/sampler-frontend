...
let chatData = [
  {
    ...
    user: '12.43.2',
    message: 'this chat works',
  },
  {
    id: 'uuid2', //uuid npm
    time: '02-23-23T09:44', //new Date()
    user: '::ffff:73.124.137.143',
    message: 'with any other connected client',
  },
  {
    id: 'uuid3', //uuid npm
    time: '02-23-23T09:45', //new Date()
    user: '::ffff:172.58.129.71',
    message: 'try opening on a second device',
  },
  {
    id: 'uuid4', //uuid npm
    time: '02-23-23T09:46', //new Date()
    user: '::ffff:172.58.129.72',
    message: 'users are detected by ip',
  },
]


export default function GroupchatOutput() {
